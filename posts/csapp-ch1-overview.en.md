...
Tracing the lifecycle of hello.c—\>creation, execution, output, and termination.
...
- Heap
	...
	The runtime **heap** can dynamically expand and contract while the program is running when functions such as `malloc` and `free` are called.
