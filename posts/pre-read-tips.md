...
updated: 2026-04-09
description: '随着新时代的到来，使用先进模型的门槛可能会因价格而加大，导致人们在认知和能力上出现明显差距。尽管当前的AI热潮让使用成本较低，但未来随着价格的上涨，只有少数人能承担使用这些模型的费用，这将造成第一轮筛选。作者感到焦虑，因为这可能会将没有资源的人排除在外，同时也反思了AI在多个领域的应用和影响。'
